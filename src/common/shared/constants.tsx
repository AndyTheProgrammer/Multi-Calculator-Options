...
export const LABELS = {
  radius: "Radius (r)",
  baseRadius: "Base Radius (r)",
  topRadius: "Top Radius(r)",
  bottomRadius: "Bottom Radius (R)",
  ...
  length: "Length (l)",
  width: "Width (w)",
  edgeLength: "Edge Length (a)",
  baseEdge: "Base Edge  (b)",
  height: "Height (h)",
  weight: "Weight (w)",
  mass: "Mass (m)",
  days: "Days (d)",
  ...
  sideC: "Side C (c)",
  angle: "Angle (θ)",
  outerDiameter: "Outer Diameter (d1)",
  innerDiameter: "Inner Diameter (d2)",
  quantity: "Quantity (q)",
  curbDepth: "Curb Depth (d)",
  curbHeight: "Curb Height (h)",
  flagThickness: "Flag Thickness ()",
  gutterWidth: "Gutter Width (w)",
  run: "Run (r)",
  rise: "Rise (r)",
...
export const LATEX = {
  cirleArea: `$A = \\pi r^{2}$`,
  rectangleArea: `$A = lw$`,
  triangleArea_sides: `$A = \\frac{a+b+c}{2}$`,
  triangleArea: `$A = \\sqrt{s(s-a)(s-b)(s-c)}$`,
  trapezoidArea: `$A = \\frac{1}{2}(x_1 + x_2 )h$`,
  sectorArea: `$A = \\frac{{\\theta}}{2} *  r^2 $`,
  ...
  capsuleSurfArea: `$Total \\ SA = 4 \\pi r^{2} + 2\\pi rh$`,
  coneSurfArea_base: `$Base \\ SA = \\pi r^{2}$`,
  coneSurfArea_lateral: `$Lateral \\ SA = \\pi 3 \\sqrt{r^{2} + h^{2}}$`,
  ...
  squarePyramidSurfArea_base: `$Base \\ SA = b^{2}$`,
  squarePyramidSurfArea_lateral: `$Lateral \\ SA = 2b \\sqrt{(b/2)^{2} + h}$`,
  squarePyramidSurfArea_total: `$Total \\ SA = b^{2} + 2b \\sqrt{(b/2)^{2} + h^{2}}$`,
  ...
  marginOfError: `$ε = z \\frac{σ}{\\sqrt{n}}$`,
