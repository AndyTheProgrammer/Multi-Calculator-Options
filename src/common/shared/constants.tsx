...
export const LABELS = {
  ...
  confidenceLevel: "Confidence Level: α",
  marginOfError: "Margin of Error: ε",
  populationProportion: "Population Proportion: p̂",
  sampleProportion: "Sample Proportion: ",
  populationStandardDeviation: "Population Standard Deviation: σ",
  sampleStandardDeviation: 'Sample Standard Deviation: sx',
  populationVariance: "Population Variance: σ2",
  sampleVariance: "Sample Variance: s2",
  sampleSize: "Sample Size: n",
  breadth: "Breadth: b",
  semiMajorAxesA: "Semi Major Axes A: a",
  semiMajorAxesB: "Semi Major Axes B: b",
  base: "Base: b",
  base1: "Base 1: b1",
  base2: "Base 2: b2",
  sideA: "Side A: a",
  ...
  time: "Time: t",
  speed: "Speed: s",
  resistanceValues: "Resistance Values: r",
  ...
  probabilityOfA: "Probability of A: P(A)",
  probabilityOfB: "Probability of B: P(B)",
  probabilityOfANotOccuring: "Probability of A not Occuring: P(A')",
  probabilityOfBNotOccuring: "Probability of B not Occuring: P(B')",
  probabilityOfAAndBBothOccuring: "Probability of A and B both Occuring: P(A∩B)",
  probabilityThatAOrBOrBothOccur: "Probability that A or B or both Occur: P(A∪B)",
  probabilityOfNeitherANorBOccuring: "Probability of Neither A nor B Occuring: P((A∪B)')",
