...
const HipUnit = (props:any) => ( 
 ...
 export default function ArmyBodyFatCalculator(){
    ...
    useEffect(()=>{
     ...
     return(
         <>
         <NavBar2 pageimage={other_icon} categoryname="Fitness Calculators" pagename="Army Body Fat Calculator" />
         <AddLayout categorykey='fitness' searchname='Fitness Calculators' searchimage={fitness_calc_icon}>
