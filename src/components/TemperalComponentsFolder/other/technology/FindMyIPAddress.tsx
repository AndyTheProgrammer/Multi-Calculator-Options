 ...
 */
 ...
 import { otherMainService, findIPService } from '../../../../services/mathService/mathMainService'
...
const HipUnit = (props:any) => ( 
 ...
 export default function FindMyIPAddress(){
    ...
    useEffect(()=>{
     ...
     return(
         <>
         <NavBar2 pageimage={other_icon} categoryname="Technology Calculators"  pagename="Find My IP Address" />
         <AddLayout categorykey='technology' searchname='Technology Calculators' searchimage={tech_calc_icon}>
                     ...
                     <Formik
                         ...
                         onSubmit = {(values)=>{
                             ...
                             const postData = async () => {
                                 ...
                                 const responseData = await findIPService(data)
