...
export default function MortgageAmortiztionCalculator(){
    ...
    return(
        <>
        <NavBar2 pageimage={finance_icon} categoryname="Money Calculators" pagename="Mortgage Amortiztion Calculator"/>
                    ...
                    <Box 
                        ...
                        <Formik
                            initialValues={{
                                ...
                                method:  "MortgageAmortiztionCalculator",
                            }}
                            onSubmit = {(values)=>{
