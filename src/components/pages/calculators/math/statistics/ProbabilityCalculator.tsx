...
import { stats_icon, math_icon } from '../../../../../common/assets';
import {
...
function ProbabilityCalculator() {
  ...
  return (
    <>
      <NavBar2
        pagename="Probability Calculator"
        pageimage={math_icon}
        categoryname="Statistics Calculators"
      />
      <AddLayout
        categorykey='statistics'
        searchname='Statistics Calculators'
        searchimage={stats_icon}
      >
        <Grid
          container
          justifyContent="center"
